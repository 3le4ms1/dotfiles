...
;; =# Shell Commands
(defun 3le4ms1/open-alacritty-here ()
...
;; (defun 3le4ms1/consult-ripgrep-single-file ()
...
;; (global-set-key (kbd "C-s") '3le4ms1/consult-ripgrep-single-file)

(defun 3le4ms1/package-unavailable-packages ()
...
;;; 3le4ms1_functions.el ends here.
