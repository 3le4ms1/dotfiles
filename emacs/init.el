...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode compat geiser-racket geiser-guile geiser php-mode erlang racket-mode crux web-mode yaml-mode chip8 kanagawa-theme ink-mode dot-env nordic-night-theme company-box projectile typescript-mode cmake-mode lorem-ipsum fireplace orderless doom-themes free-keys license-templates dash powershell consult marginalia vertico ripgrep lsp-ui lsp-haskell eglot haskell-mode hindent sly gnuplot htmlize flycheck-rust lua-mode restart-emacs toml-mode rust-mode company-auctex math-symbol-lists ascii-table emmet-mode which-key gnuplot-mode auto-complete-c-headers company-c-headers ahk-mode rainbow-delimiters magit bash-completion company gdscript-mode ligature toc-org org-bullets org-appear org-super-agenda flycheck drag-stuff zoom use-package buffer-move simpleclip markdown-mode multiple-cursors gruber-darker-theme))
