...
(custom-set-variables
 ...
 '(coq-prog-name "C:\\ProgramData\\scoop\\shims\\coqtop.exe")
 ...
 '(package-selected-packages
   '(geiser-racket geiser-guile geiser php-mode company-erlang erlang racket-mode crux web-mode yaml-mode company-coq chip8 kanagawa-theme ink-mode dot-env julia-mode nordic-night-theme company-box projectile arduino-mode typescript-mode cmake-mode lorem-ipsum fireplace orderless doom-themes free-keys license-templates dash powershell consult marginalia vertico ripgrep lsp-ui lsp-haskell eglot haskell-mode hindent sly gnuplot htmlize flycheck-rust lua-mode restart-emacs toml-mode rust-mode company-auctex math-symbol-lists ascii-table emmet-mode which-key gnuplot-mode auto-complete-c-headers company-c-headers ahk-mode rainbow-delimiters magit bash-completion company gdscript-mode ligature toc-org org-bullets powerline-evil org-appear org-super-agenda flycheck drag-stuff zoom use-package buffer-move simpleclip evil markdown-mode multiple-cursors treemacs gruber-darker-theme))
