...
;; lato, quando di preme `M-x' per eseguire un comando Per modificare la
;; visualizzazione delle descrizioni si può ciclare tramite la la keybinding
;; associata al comando `marginalia-cycle'
