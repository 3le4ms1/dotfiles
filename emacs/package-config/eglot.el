...
;; ai server LSP (Language Server Provider), che permettono
...
(use-package eglot
  ...
  ;; (define-key eglot-mode-map (kbd "C-c C-SPC") #'company-complete)
  (define-key eglot-mode-map (kbd "C-c SPC")   #'eldoc-doc-buffer)
